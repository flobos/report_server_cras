...
Public Class rpt_reporte_lotes_trabajo
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_reporte_lotes_trabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_reporte_lotes_trabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_reporte_lotes_trabajo = New rpt_reporte_lotes_trabajo
        rpt.Site = Me.Site
        Return rpt
    End Function
