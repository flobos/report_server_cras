...
Public Class rpt_informe_aprobacion_rpnp
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_informe_aprobacion_rpnp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tipo_muestra As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class Cachedrpt_informe_aprobacion_rpnp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_informe_aprobacion_rpnp = New rpt_informe_aprobacion_rpnp
        rpt.Site = Me.Site
        Return rpt
    End Function
