...
Public Class rpt_lotes_por_comuna
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_lotes_por_comuna.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_seg_div_pol_idn As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class Cachedrpt_lotes_por_comuna
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_lotes_por_comuna = New rpt_lotes_por_comuna
        rpt.Site = Me.Site
        Return rpt
    End Function
