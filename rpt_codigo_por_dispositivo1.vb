...
Public Class rpt_codigo_por_dispositivo
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_codigo_por_dispositivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_det_disp_idn As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class Cachedrpt_codigo_por_dispositivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_codigo_por_dispositivo = New rpt_codigo_por_dispositivo
        rpt.Site = Me.Site
        Return rpt
    End Function
