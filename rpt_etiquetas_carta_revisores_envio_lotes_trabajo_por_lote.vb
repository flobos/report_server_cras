...
Public Class rpt_etiquetas_carta_revisores_envio_lotes_trabajo_por_lote
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_etiquetas_carta_revisores_envio_lotes_trabajo_por_lote.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fun_rut As CrystalDecisions.Shared.IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_lot_trab_idn As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class Cachedrpt_etiquetas_carta_revisores_envio_lotes_trabajo_por_lote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_etiquetas_carta_revisores_envio_lotes_trabajo_por_lote = New rpt_etiquetas_carta_revisores_envio_lotes_trabajo_por_lote
        rpt.Site = Me.Site
        Return rpt
    End Function
