...
Public Class rpt_cartas_aviso_fecha
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_cartas_aviso_fecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cartas_aviso_fecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cartas_aviso_fecha = New rpt_cartas_aviso_fecha
        rpt.Site = Me.Site
        Return rpt
    End Function
