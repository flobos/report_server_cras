...
Public Class lote_reporte_cuadratura
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "lote_reporte_cuadratura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlote_reporte_cuadratura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lote_reporte_cuadratura = New lote_reporte_cuadratura
        rpt.Site = Me.Site
        Return rpt
    End Function
