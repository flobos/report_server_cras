...
Public Class rpt_pago_lote_particular
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_pago_lote_particular.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_pago_lote_particular
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_pago_lote_particular = New rpt_pago_lote_particular
        rpt.Site = Me.Site
        Return rpt
    End Function
