...
Public Class rpt_cuadratura_de_trabajo
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_cuadratura_de_trabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cuadratura_de_trabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cuadratura_de_trabajo = New rpt_cuadratura_de_trabajo
        rpt.Site = Me.Site
        Return rpt
    End Function
