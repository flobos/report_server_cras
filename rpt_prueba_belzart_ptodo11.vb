...
Public Class rpt_prueba_belzart_ptodo1
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_prueba_belzart_ptodo1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_prueba_belzart_ptodo1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_prueba_belzart_ptodo1 = New rpt_prueba_belzart_ptodo1
        rpt.Site = Me.Site
        Return rpt
    End Function
