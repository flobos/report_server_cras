...
Public Class rpt_boletas_de_pago_imprime2
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "rpt_boletas_de_pago_imprime2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fecha As IParameterField
        Get
...
Public Class Cachedrpt_boletas_de_pago_imprime2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_boletas_de_pago_imprime2 = New rpt_boletas_de_pago_imprime2
        rpt.Site = Me.Site
        Return rpt
    End Function
