...
Public Class rpt_boletas_imprime_pmes_global
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "rpt_boletas_imprime_pmes_global.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property PageFooterSection1 As Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fec As IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_año As IParameterField
        Get
...
Public Class Cachedrpt_boletas_imprime_pmes_global
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_boletas_imprime_pmes_global = New rpt_boletas_imprime_pmes_global
        rpt.Site = Me.Site
        Return rpt
    End Function
