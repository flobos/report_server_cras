...
Public Class rpt_imprime_caratulas
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_imprime_caratulas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_imprime_caratulas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_imprime_caratulas = New rpt_imprime_caratulas
        rpt.Site = Me.Site
        Return rpt
    End Function
