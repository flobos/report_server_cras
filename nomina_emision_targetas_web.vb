...
Public Class nomina_emision_targetas_web
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "nomina_emision_targetas_web.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednomina_emision_targetas_web
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nomina_emision_targetas_web = New nomina_emision_targetas_web
        rpt.Site = Me.Site
        Return rpt
    End Function
