...
Public Class rpt_nomina_llamados
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_nomina_llamados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_nomina_llamados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_nomina_llamados = New rpt_nomina_llamados
        rpt.Site = Me.Site
        Return rpt
    End Function
