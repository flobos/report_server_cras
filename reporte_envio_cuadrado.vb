...
Public Class reporte_envio_cuadrado
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "reporte_envio_cuadrado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pro_nombre As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class Cachedreporte_envio_cuadrado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_envio_cuadrado = New reporte_envio_cuadrado
        rpt.Site = Me.Site
        Return rpt
    End Function
