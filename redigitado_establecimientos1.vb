...
Public Class redigitado_establecimientos
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "redigitado_establecimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedredigitado_establecimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As redigitado_establecimientos = New redigitado_establecimientos
        rpt.Site = Me.Site
        Return rpt
    End Function
