...
Public Class rpt_web_pru_bel_pfecha
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rpt_web_pru_bel_pfecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_web_pru_bel_pfecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_web_pru_bel_pfecha = New rpt_web_pru_bel_pfecha
        rpt.Site = Me.Site
        Return rpt
    End Function
